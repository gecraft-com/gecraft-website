...
export const ContactUsPage = () => {
  return (
    <div className="bg-secondary-200 rounded-3xl px-7 py-5 md:px-12 md:py-11 xl:rounded-[4rem] xl:px-14 xl:py-12">
      ...
      <p className="font-readexPro mt-2 text-lg md:mt-3 md:text-3xl xl:mt-6 xl:text-4xl">
      ...
      <div className="mt-7 md:mt-11 xl:mt-16 xl:flex xl:flex-row-reverse xl:gap-10">
        <div className="xl:flex xl:min-w-96 xl:flex-col 2xl:min-w-[36rem]">
          <h3 className="font-readexPro text-lg font-semibold md:text-xl xl:text-3xl">
            What to Expect:
          </h3>
          ...
          <h3 className="font-readexPro mt-4 text-lg font-semibold md:text-xl xl:mt-6 xl:text-3xl">
            Let’s create <br className="md:hidden" /> something amazing!
          </h3>
        </div>
        <Form onPage />
      </div>
