...
function ContactUsPage() {
  return (
    <div className="rounded-3xl bg-primary-850 px-7 py-5 text-white sm:px-12 sm:py-11 xl:rounded-[4rem] xl:px-14 xl:py-12">
      ...
      <p className="mt-2 font-readexPro text-lg sm:mt-3 sm:text-3xl xl:mt-6 xl:text-4xl">
      ...
      <div className="mt-7 sm:mt-11 xl:mt-16 xl:flex xl:flex-row-reverse xl:gap-10">
        <div className="xl:flex xl:min-w-96 xl:flex-col 2xl:min-w-[36rem]">
          <h3 className="font-readexPro text-lg font-semibold text-primary-900 sm:text-xl xl:text-3xl">
            What to Expect:
          </h3>
          <ul className="mt-3 text-primary-900 xl:text-lg">
          ...
          <h3 className="mt-4 font-readexPro text-lg font-semibold text-primary-900 sm:text-xl xl:mt-6 xl:text-3xl">
