export function Modal({ children, setModal }) {
  ...
  return (
    <div
      ...
      onClick={closeModal}
    >
      <div className="relative rounded-lg bg-primary-400 p-3">
        <div className="absolute right-5 top-5 w-8 cursor-pointer" onClick={closeModal}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 130 127"
            className="h-full w-full fill-white hover:fill-primary-200"
          >
            <g clipPath="url(#a)">
              <path
