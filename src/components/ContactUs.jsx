  ...
  return (
    ...
    >
      <div className="flex flex-col">
        ...
        <p className="animation-timeline animate-appear mt-[7.7vw] text-[5.15vw] font-bold uppercase md:mt-[2.65vw] md:text-[1.77vw] lg:mt-[1.57vw] lg:text-[1.05vw] 2xl:mt-[1.46vw] 2xl:text-[0.59vw]">
          Phone
        </p>
        <a
          href="tel:+995558599550"
          className="animation-timeline animate-appear mt-[1.3vw] text-[6.7vw] font-bold md:mt-[0.45vw] md:text-[2.3vw] lg:mt-[0.27vw] lg:text-[1.36vw] 2xl:mt-[0.15vw] 2xl:text-[1.4vw]"
        >
          +(995) 558 599 550
        </a>
        <a
        ...
        <p className="animation-timeline animate-appear mt-[5.15vw] text-[5.15vw] font-bold uppercase md:mt-[1.77vw] md:text-[1.77vw] lg:mt-[1.05vw] lg:text-[1.05vw] 2xl:mt-[0.59vw] 2xl:text-[0.59vw]">
          Email
        </p>
        <a
        ...
        <img
          ...
          alt="logo"
          className="animation-timeline animate-appear mt-[5.15vw] w-[33.35vw] md:mt-[3.53vw] md:w-[11.48vw] lg:mt-[2.09vw] lg:w-[6.77vw] 2xl:mt-[1.17vw] 2xl:w-[5.17vw]"
        />
      </div>
      <FormContactUs />
    </div>
