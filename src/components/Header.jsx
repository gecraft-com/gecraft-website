...
function Header() {
  return (
    <header className="relative flex w-full flex-col items-center px-5 pb-[40vw] md:bg-bgHeader md:px-0 md:pb-[8.84vw] lg:pb-[5.2vw] 2xl:pb-[8.36vw]">
      ...
      <a
        className="z-10 mt-[42.3vw] flex h-[20.5vw] w-[89.7vw] items-center justify-center rounded-full border-2 border-basic text-[4.1vw] text-base font-semibold text-basic hover:border-buttonHover hover:bg-buttonHover md:mb-[9.8vw] md:mt-[8.84vw] md:h-[5.93vw] md:w-[32.7vw] md:text-[1.77vw] lg:mb-[8.49vw] lg:mt-[6.77vw] lg:h-[4.17vw] lg:w-[28.1vw] lg:text-[1.36vw] 2xl:mb-[8.48vw] 2xl:mt-[6vw] 2xl:h-[4.15vw] 2xl:w-[30.84vw] 2xl:text-[1.4vw]"
        href="#"
      >
      ...
      <p
        id="text"
        className="z-20 mt-[25.6vw] w-[89.7vw] select-none text-[6.15vw] leading-tight text-white md:mt-[8.84vw] md:w-[62.9vw] md:text-[2.65vw] lg:w-[50.1vw] lg:text-[2.5vw] 2xl:w-[49.4vw] 2xl:text-[2.44vw]"
      >
