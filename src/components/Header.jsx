...
const Header = () => {
  return (
    <header className="relative flex w-full flex-col items-center px-5 pb-20 sm:bg-bgHeader sm:px-0 2xl:pb-72">
      ...
      <p className="mt-10 cursor-default select-none text-2xl text-basic sm:mt-0 sm:text-4xl 2xl:text-8xl">
        Your Reliable Partner
      </p>
      <p className="cursor-default select-none text-2xl text-basic sm:text-4xl 2xl:text-8xl">
      ...
      <p className="z-10 mt-24 w-full cursor-default select-none text-2xl leading-tight text-white sm:w-[600px] sm:text-3xl lg:w-[969px] lg:text-5xl 2xl:w-[1450px] 2xl:text-7xl">
