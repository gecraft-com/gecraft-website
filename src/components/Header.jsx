...
function Header() {
  return (
    <header className="relative flex w-full flex-col items-center px-5 pb-[40vw] md:bg-bgHeader md:px-0 md:pb-[8.84vw] lg:pb-[5.2vw] 2xl:pb-[8.36vw]">
      <MobileAppBar />
      <h1 className="title-gradient mt-24 hidden animate-descent select-none bg-clip-text font-sans text-[22vw] font-black not-italic leading-none text-transparent duration-500 md:mt-0 md:block">
        GeCraft
      </h1>

      <h1 className="title-gradient mt-[46vw] animate-descent select-none font-sans text-[55vw] font-black not-italic leading-none md:hidden">
        Ge
      </h1>
      <h2 className="title-gradient animate-descent select-none font-sans text-[22vw] font-black not-italic leading-none md:hidden">
        Craft
      </h2>

      <p className="mt-10 animate-emergence select-none text-[6.15vw] text-basic md:mt-0 md:text-[2.12vw] lg:text-[1.88vw] 2xl:text-[2.79vw]">
